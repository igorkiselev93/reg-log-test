...
<div class="container">
    ...
    <form class="form-signin" id="ajax_form" method="post" action="" autocomplete="off">
        <input class="form-control" type="text" name="username" placeholder="Ваш ник" auto required>
        ...
        <input class="form-control" type="text" name="firstname" placeholder="Ваше имя" required>
